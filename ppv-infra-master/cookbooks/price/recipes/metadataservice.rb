...
config = data_bag_item(databag_name, node['price']['metadataservice']['databag_item'])
...
metadataservice_version = versions['metadataservice_version']
...
template "/opt/periscope/#{component_name}/#{component_name}.conf" do
  source 'metadataservice_config.erb'
  mode '0644'
