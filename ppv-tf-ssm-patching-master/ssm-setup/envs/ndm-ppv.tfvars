## Generic
ssm_patching_bucket_name = "ppv-ssm-patching-logs"
...
mw_patching_group_three_schedule = "cron(0 30 4 ? 1/1 SUN#4 *)"
mw_patching_group_three_duration = 6
mw_patching_group_three_cutoff   = 3

mw_patching_group_four_name     = "mw-patching-group-4"
mw_patching_group_four_schedule = "cron(0 30 14 ? 1/1 SUN#4 *)"
mw_patching_group_four_duration = 6
mw_patching_group_four_cutoff   = 3
...
patching_group4_s3_log_prefix    = "InstallPatchLogs_PatchGroup4"
