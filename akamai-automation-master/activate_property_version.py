...
# Activate version
body = {
    'propertyVersion': os.environ['PROPERTY_VERSION'],
    'network': os.environ['ACTIVATION_NETWORK'],
    'note': os.environ['ACTIVATION_NOTE'],
    'useFastFallback': False,
    'notifyEmails': [
        'hector_bastos@mckinsey.com',
        'msv_sre@mckinsey.com'
    ],
...
path = '/papi/v1/properties/{}/activations'.format(akamai_keys['propertyId'])
url = urljoin(akamai_keys['host'], path)
try:
    logging.info("Activating version {}.".format(
        os.environ['PROPERTY_VERSION']))
...
logger.info("Version {} has been activated: {}".format(
    os.environ['PROPERTY_VERSION'], response.json()))
