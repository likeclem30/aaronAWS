...
managed_policies = [
  ...
  "arn:aws:iam::949421251013:policy/con_ec2_autoscaling_access",
  "arn:aws:iam::949421251013:policy/ppv_byok_kms_key_access",
  "arn:aws:iam::949421251013:policy/spark_create_tag",
  "arn:aws:iam::949421251013:policy/ndm-ppv-CMK-access"
]

all_roles = ["", "_elasticsearch", "_jenkins", "_mgmt", "_rdp", "_spark"]
route53   = ["", "_mgmt", "_spark"]
s3_common = ["", "_spark"]
con_ec2   = ["", "_jenkins", "_mgmt"]