...
# Get node attributes
ecr_region = node['mash-ipwl-ppv']['ecr_region']
ecr_registry_ids = node['mash-ipwl-ppv']['ecr_registry_ids']
ecr_repo_uri = node['mash-ipwl-ppv']['ecr_repo_uri']
nginx_dir = node['mash-ipwl-ppv']['nginx_dir']
nginx_dir_temp = node['mash-ipwl-ppv']['nginx_dir_temp']
container_name = node['mash-ipwl-ppv']['container_name']
sites = node['mash-ipwl-ppv']['sites']
sample_ips = node['mash-ipwl-ppv']['sample_ips']
docker_tarball_url = node['mash-ipwl-ppv']['docker_tarball_url']
docker_tarball_version = node['mash-ipwl-ppv']['docker_tarball_version']
docker_tarball_checksum = node['mash-ipwl-ppv']['docker_tarball_checksum']
mode_true_client_ip_header = node['mash-ipwl-ppv']['mode_true_client_ip_header']
